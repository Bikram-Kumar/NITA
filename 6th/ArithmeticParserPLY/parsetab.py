...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','Parser.py',42),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','Parser.py',47),
  ('expression -> term','expression',1,'p_expression_term','Parser.py',52),
  ('term -> term TIMES factor','term',3,'p_term_times','Parser.py',57),
  ('term -> term DIVIDE factor','term',3,'p_term_divide','Parser.py',62),
  ('term -> factor','term',1,'p_term_factor','Parser.py',67),
  ('factor -> NUMBER','factor',1,'p_factor_number','Parser.py',72),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','Parser.py',77),
]
